...
class SwingBacktesterWithScaling:
    def __init__(self, excel_path, swing_window=1, sl_multiplier=2):
    ...
    def load_data(self):
        self.data = pd.read_excel(self.excel_path, sheet_name=f'Window_{self.swing_window}', index_col='timestamp', parse_dates=True)
    ...
    def run_backtest(self):
        ...
        for i in range(1,len(data)):
            ...
            swing_low = data['swings_low'].iloc[i-self.swing_window]
            recent_swing_low = data['l'].iloc[i-self.swing_window] if swing_low else None
            ...
            # Scaling in
                ...
                if position == 1:
                    ...
                    if low <= bullish_SL_price or signal == -1:
            ...
            # Scaling in
                ...
                # If new swing high, scale in
                    ...
                    # Check for stop loss hit
                    if high >= bearish_SL_price or signal ==1:
